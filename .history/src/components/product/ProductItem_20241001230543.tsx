...
export default function ProductItem(props: ProductItemProps) {
  ...
  return (
    ...
    >
      <div className="absolute flex justify-center top-2.5 right-2.5">
        <ScoreReview score={product.score} size={} />
      </div>
      ...
      <div className="flex-1 flex flex-col gap-3 p-5 border-t border-white/10">
        ...
        <button
          className="flex justify-center items-center gap-2 h-8 bg-violet-700 hover:border-2 border-emerald-500 rounded-md"
          onClick={(e) => {
            e.preventDefault();
