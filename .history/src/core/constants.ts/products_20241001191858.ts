...
const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "O Razer BlackWidow V3 é equipado com switches mecânicos Razer Green para uma resposta tátil precisa e feedback auditivo satisfatório. Possui Lighting RGB Razer Chroma e estrutura em alumínio para maior durabilidade.",
    brand: "Razer",
  ...
  },
  {
    ...
    description:
      "O Razer Kraken X é um headset ultraleve com som surround 7.1 e almofadas em espuma com memoria para máximo conforto. Microfone cardioide e estrutura reforçada para durabilidade.",
    brand: "Razer",
