...
const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "O Razer Kraken X é um headset ultraleve com som surround 7.1 e almofadas em espuma com memoria para máximo conforto. Microfone cardioide e Structure reforçada para durabilidade.",
    brand: "Razer",
