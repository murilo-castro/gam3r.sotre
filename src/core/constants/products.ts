...
const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "O Razer BlackWidow V3 é equipado com switches mecânicos Razer Green para uma resposta tátil precisa e feedback auditivo satisfatório. Possui Lighting RGB Razer Chroma e Structure em alumínio para maior durabilidade.",
    brand: "Razer",
  ...
  },
  {
    ...
    description:
      "Com switches Cherry MX Red, o Corsair K70 RGB MK.2 oferece resposta linear e silenciosa. Construído em alumínio escovado, ideal para sessões longas de gameplay, e com Lighting RGB dinâmica.",
    brand: "Corsair",
    model: "CH-9109010-NA",
    image:
    ...
    tags: ["RGB Dinâmico", "Structure em Alumínio", "Switch Silencioso"],
    base_price: 1799.99,
    sale_price: 1349.99,
  ...
  },
  {
    ...
    description:
      "O Redragon Draconic K530 é um teclado mecânico compacto, sem fio, projetado para máxima portabilidade e desempenho. Equipado com switches Outemu Brown, ideal para quem busca um equilíbrio entre feedback tátil e silêncio, além de Connectivity Bluetooth.",
    brand: "Redragon",
    model: "K530-RGB",
    image:
  ...
  },
  {
    ...
    description:
      "O Logitech G403 Hero é equipado com o sensor HERO 25K, oferecendo precisão máxima com até 25.600 DPI ajustáveis. Design ergonômico, Structure leve e Weight ajustável, ideal para quem busca conforto e alto desempenho em jogos.",
    brand: "Logitech",
    model: "910-005631",
    image:
  ...
  },
  {
    ...
    description:
      "O HyperX Pulsefire FPS Pro é ideal para jogadores que buscam precisão e conforto. Equipado com o sensor Pixart 3389 de até 16.000 DPI e botões Omron com alta durabilidade. Lighting RGB personalizável e design ergonômico.",
    brand: "HyperX",
    model: "HX-MC003B",
    image:
  ...
  },
  {
    ...
    tags: ["Confortável", "Surround 7.1", "Microphone Removível"],
    base_price: 899.99,
    sale_price: 699.99,
    lowest_price: 649.99,
  ...
  },
  {
    ...
    description:
      "O Razer Kraken X é um headset ultraleve com som surround 7.1 e almofadas em espuma com memoria para máximo conforto. Microphone cardioide e Structure reforçada para durabilidade.",
    brand: "Razer",
  ...
  },
  {
    ...
    description:
      "O Samsung Odyssey G7 possui taxa de atualização de 240Hz e tempo de resposta de 1ms. Com painel curvo QHD e Technology G-Sync, é ideal para gamers que buscam desempenho e imersão.",
    brand: "Samsung",
  ...
  },
  {
    ...
    description:
      "A RTX 3060 Ventus 2X MSI é equipada com 12GB GDDR6, oferecendo desempenho de última geração para jogos 4K e Ray Tracing. Possui suporte a DLSS e Technologys avançadas da NVIDIA para máxima performance.",
    brand: "MSI",
  ...
  },
  {
    ...
    description:
      "A RX 6800 XT possui 16GB GDDR6 e arquitetura RDNA 2, proporcionando excelente desempenho em jogos 1440p e 4K. Inclui suporte a Ray Tracing e Technology Smart Access Memory para CPUs Ryzen.",
    brand: "ASRock",
  ...
  },
  {
    ...
    description:
      "A ROG Strix Z590-E é uma placa-mãe premium para processadores Intel de 11ª geração, com suporte a overclock, Wi-Fi 6E integrado e Lighting RGB ASUS Aura Sync.",
    brand: "ASUS",
  ...
  },
  {
    ...
    description:
      "O kit Corsair Vengeance RGB Pro oferece desempenho de alto nível para jogadores e criadores de conteúdo, com 16GB de capacidade, frequência de 3200MHz e Lighting RGB dinâmica.",
    brand: "Corsair",
